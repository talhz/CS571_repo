...
from utils.layer_generators import make_generators_fcn, make_generators_fcn_DUN
...
if __name__ == "__main__":
    ...
    for omega in range(0, 21, 2):
        train_loader, valid_loader, test_loader = load_data_spiral(omega, BATCH_SIZE, SEED)
        ...
        for _ in range(5):
            ...
            model.model_name += ".spiral.v2.O-%d.seed-%d.lr%.4f" % (omega, SEED, LR) + "iter%d" % _
